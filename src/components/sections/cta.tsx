...
const CTASection = () => {
    return (
        <section className="bg-primary py-20 md:py-32 md:pt-40 ">
            <div className="container max-w-6xl mx-auto px-4">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/contact">
                            <button className="inline-flex items-center justify-center px-12 py-4 text-lg text-primary bg-secondary rounded-full hover:opacity-90 transition-all duration-300">
                                Get Started
                            </button>
                        </Link>
