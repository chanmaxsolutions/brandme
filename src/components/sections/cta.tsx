            ...
            <div className="container max-w-6xl mx-auto px-4">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/contact">
                            <button className="inline-flex items-center justify-center px-12 py-4 text-lg text-secondary bg-primary rounded-full hover:opacity-90 transition-all duration-300">
                                Get Started
                            </button>
                        </Link>
