            ...
            <div className="relative container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <button className="inline-flex items-center justify-center px-8 py-4 text-lg  text-white bg-primary rounded-full hover:opacity-90 transition-all duration-300">
                            Get A Quote

                        </button>
                        <button className="inline-flex items-center justify-center px-8 py-4 text-lg  text-primary border-2 border-primary rounded-full hover:bg-secondary hover:text-white transition-all duration-300">
                            Our Services
                        </button>
                    </div>
                </div>
