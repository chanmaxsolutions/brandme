                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 pb-16">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <Link href="https://www.facebook.com/brandme.top/" target="_blank" className="text-secondary hover:text-secondary/80 transition-colors">
                            ...
                            <Link href="https://www.linkedin.com/company/brandme-top/" target="_blank" className="text-secondary hover:text-secondary/80 transition-colors">
